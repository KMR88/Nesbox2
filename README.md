...
NOTICE: I have changed the password, and it will be back tomorrow.
This github page has password protection, and the password is "playingames" without the quotes
